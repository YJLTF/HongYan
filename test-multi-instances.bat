@echo off
REM Test script to launch three HongYan instances (Windows Batch)
...
echo Starting HongYan Instance 3...
start "HongYan Test 3" cmd /c "set HONGYAN_DATA_DIR=HongYan-Test3&& set HONGYAN_UDP_PORT=19880&& set HONGYAN_TCP_PORT=19881&& npx electron dist/main/index.js"
...
echo Instance 3: UDP 19880, TCP 19881, data dir HongYan-Test3
echo.
